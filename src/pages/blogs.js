  ...
  render() {
    ...
    return (
      <Layout className="mh100" theme={this.state.theme} themer={this.themer}>
        <SEO title="harphies Journal | harphies blogs" />
        <div>
          ...
          <div className="mh90vh blog marginT15">
            ...
            <div
              className="inbl posRel width60 skillDesc fillUpFromZero mw100"
              style={{ animationDelay: "0.2s" }}
            >
              {post && (
                <div className=" posAbs themeBg blogcounter">
                  {this.getNumber(post.postNum)}
                </div>
              )}
              <div
                className="posAbs transCenter mw90"
                style={{ maxWidth: "100%" }}
              >
                {post && (
                  <Link className=" " to={post.path}>
                    <div
                      className="op0 opAnimator white fb fs35 lh2em textcenter fs-s-28 pad10"
                      style={{
                        textAlign: "left",
                    ...
                    <div
                      className=" op0 opAnimator white padT10 padB10"
                      style={{ fontSize: "13px", animationDelay: "0.3s" }}
                    >
                      {post.description}
                    </div>
                    <div
                    ...
                    >
                      ...
                      <div
                        className="op0 opAnimator white inbl padR10"
                        style={{ fontSize: "13px", animationDelay: "0.3s" }}
                      >
                        Read more
                      </div>
            ...
            <div className="inbl posRel width40 fillUpFromZero mw100">
              <div
                className="posAbs transCenter lh2em "
                style={{ width: "90%", margin: "10px auto" }}
              >
                <div className="posRel">
                  <div className="width100 textcenter fs35 hide650px padT10">
                    <div className="oh">
                      <FadeIn className="marginT10 padding10">
                        A Series of{" "}
                      </FadeIn>
                    </div>
                    <div className="padT10 oh marginB50">
                      <FadeIn className="textcenter fs35  padding10">
                        Accidental blogs
                      </FadeIn>
                    </div>
                  </div>
                  <div className="mh40scroll">
                    {data.allMarkdownRemark.edges.map((post, index) => {
                      ...
                      return (
                        <div
                          className={
                            "descriptionTxtColor padB10 hand textright padR20p  " +
                            (selectedId === id ? " selPostHeader" : "")
                          }
                          onClick={() => {
                            this.loadDetails(id, index + 1, frontmatter)
                          }}
                        >
                          {frontmatter.smallTitle}
                        </div>
                      )
                    })}
                  </div>
                  <div className="textright">
                    ...
                    <span className="padR20p ico12">Scroll for more</span>
                  </div>
                </div>
              </div>
            </div>
