...
import { consultationSvc } from "../components/constants"
...
class Skills extends React.Component {
  ...
  renderHalf(second) {
    ...
    const toMap = second ? consultationSvc : consultationSvc
    return (
      <div>
        {toMap.map(skill => {
          return (
  ...
  render() {
    return (
      <Layout className="mh100" theme={this.state.theme} themer={this.themer}>
        <SEO title="Cloud Consultation Services" />
        <div>
          <div className="mh90vh">
            <div className="width100 textcenter oh">
              <FadeIn className=" fs35 fadeInWord ">Consultation Services</FadeIn>
            </div>
