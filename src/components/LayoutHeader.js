  ...
  render() {
    ...
    return (
      <div className={className}>
        {this.state.showMenu && (
          <div className="posRel ">
            <div className="menuContainer">
              <div>
                <MdClose
                  className="themeHover hand menuFont lh2em closeBtn"
                  onClick={() => {
              ...
              <div className="transCenter menuHeadingContainer widthOptimize textcenter">
                <Link to="/">
                  <div
                    className={
                      "themeHover hand menuFont fb lh2em " +
                      (currPath === "/" ? "themeColor" : "")
                    }
                  >
                    Home
        ...
        <div className="posRel">
          <div className="loaderTransition" />
          <div className="">
            <div
            ...
            >
              <TiThMenu
                className="hand fl fadeInWord ico25 crumb"
